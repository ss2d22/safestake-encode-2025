...
async fn main() -> Result<(), Error> {
    ...
    use safestake_registry::CustomInputParameter; // Example

    let param = OwnedParameter::from_serial(&CustomInputParameter { num: 42 })?; // Example

    let init_method_name: &str = "init_safestake_registry"; // Example
    ...
    let update_payload = transactions::UpdateContractPayload {
        ...
        receive_name: OwnedReceiveName::new_unchecked("safestake_registry.receive".to_string()),
